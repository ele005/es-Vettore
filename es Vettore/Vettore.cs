...
namespace es_Vettore
{
    internal class Vettore
    {
        ...
        {
            return (Math.Sqrt(v1.x * v1.x + v1.y * v1.y)) * (Math.Sqrt(v2.x * v2.x + v2.y * v2.y) * Math.Cos(Angolo.Vettore(v1, v2)));
        }
    ...
    static double Angolo(Vettore v1, Vettore v2)
    {
